...
public abstract class CoreBaseFragment<T extends CoreBasePresenter, E extends CoreBaseModel> extends SupportFragment {
    ...
    public T mPresenter;/* p 层对象*/
    public E mModel;/* m 层对象*/
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnBackToFirstListener) {
            _mBackToFirstListener = (OnBackToFirstListener) context;/* 对到第一个 fragment 监听*/
        }
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        //设置状态栏透明
        setStatusBarColor();
        mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);/*设置方向*/
        TAG = getClass().getSimpleName();/*获取 该类名称*/
